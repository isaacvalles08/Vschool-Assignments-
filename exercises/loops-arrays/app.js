...
//          console.log(peopleWhoWantToSeeMadMaxFuryRoad[i].name + " can see")
//      }   else{
...
//         console.log(peopleWhoWantToSeeMadMaxFuryRoad[i].name + " is old enough he can see")
...
//     }
//   ] 
//   for(i = 0; i < peopleWhoWantToSeeMadMaxFuryRoad.age; i++){
//       if(peopleWhoWantToSeeMadMaxFuryRoad[i].age >= 18){
...
//   if(peopleWhoWantToSeeMadMaxFuryRoad[i].age >= 18){
//     console.log(peopleWhoWantToSeeMadMaxFuryRoad.name + " can see the movie")
//   }
// 
